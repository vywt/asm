...
loop:
  ...
  add $8,$8,$8			# Multiply each side by 2
  add $9,$9,$9
  add $8,$8,$9			#add perimeter into $8
  ...
  syscall           			# print the string
  				...
  				# Print the calculated perimeter (in $8)
  addi 	$v0, $0, 1  			# system call 1 is for printing an integer
  add 	$a0, $0, $8 			# bring the preimeter value from $8 into $a0
  syscall           			# print the integer
